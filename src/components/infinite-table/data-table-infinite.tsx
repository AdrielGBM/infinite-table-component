...
export function DataTableInfinite<TData, TValue, TMeta>({
  ...
  const table = useReactTable({
    ...
    debugAll: import.meta.env.VITE_PUBLIC_TABLE_DEBUG === "true",
      ...
      >
        ...
        <div
          className={cn(
            ...
            // Chrome issue
            "group-data-[expanded=true]/controls:sm:max-w-[calc(100vw-208px)] group-data-[expanded=true]/controls:md:max-w-[calc(100vw-288px)]"
          )}
        >
          <div
            ref={topBarRef}
